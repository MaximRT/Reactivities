        ...
        >
            {({ handleSubmit, isSubmitting, errors, isValid, dirty }) => (
                <Form className='ui form error' onSubmit={handleSubmit} autoComplete='off'>
                    <Header as='h2' content='Регистрация в ActivityLife' color="teal" textAlign="center" />
                    <MyTextInput placeholder="Имя профиля" name='displayName' />
                    <MyTextInput placeholder="Имя пользователя" name='username' />
